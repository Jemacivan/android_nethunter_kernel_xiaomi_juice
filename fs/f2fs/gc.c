...
static int drm_panel_notifier_callback(struct notifier_block *self,
...
static struct notifier_block fb_notifier_block = {
	.notifier_call = drm_panel_notifier_callback,
};
...
void __init f2fs_init_rapid_gc(void)
{
	...
	if (active_panel)
		drm_panel_notifier_register(active_panel, &fb_notifier_block);
}

void __exit f2fs_destroy_rapid_gc(void)
{
	if (active_panel)
		drm_panel_notifier_unregister(active_panel, &fb_notifier_block);
